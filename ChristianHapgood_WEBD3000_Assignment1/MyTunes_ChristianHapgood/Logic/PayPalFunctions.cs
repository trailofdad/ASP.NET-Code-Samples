...
using System.Web;
using MyTunes_ChristianHapgood;
...
public class NVPAPICaller
{
    ...
    public string APIUsername = "christian.hapgood-facilitator_api1.gmail.com";
    private string APIPassword = "7HTKV9TFK2NPVKLH";
    private string APISignature = "AiPC9BjkCyDFQXbSkoZcgqH3hpacAwRpqWRc1cQwHV6s3bTeIalovTL3";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (MyTunes_ChristianHapgood.Logic.ShoppingCartActions myCartOrders = new MyTunes_ChristianHapgood.Logic.ShoppingCartActions())
        {
